...
def create_image_with_diagonal_border(width, height, frame_thickness, border_size, colors, angle):
    """Create an image with diagonal borders."""
    scale_factor = 8
...
def draw_wrapped_text(image, word, definition, border_size, word_font_size=40, def_font_size=20, font_path=None, text_color="black", align="left", word_padding=20, def_padding=10, footer_text="keyesc.xyz", footer_font_size=20):
    """
    ...
    - word_font_size: The size of the font for the word. Default is 40.
    - def_font_size: The size of the font for the definition. Default is 20.
    ...
    - footer_text: The footer text to display in the bottom right corner. Default is "keyesc.xyz".
    ...
    if font_path:
        ...
        def_font = ImageFont.truetype(font_path, def_font_size)
